...
def execute(context: dict, inputs: dict) -> dict:
    ...
    return {
        "status": "completed",
        "message": f"Moved Z to left {response.target['z_left_cm']:g} cm, right {response.target['z_right_cm']:g} cm.",
        ...
        "on_the_fly_calibration": response.on_the_fly_calibration,
        "calibration_max_diff_steps": response.calibration_max_diff_steps,
